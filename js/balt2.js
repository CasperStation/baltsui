document.addEventListener('DOMContentLoaded', function () {
    ...
    // Function to create and animate a GIF
    function createAndAnimateGIF() {
        const img = document.createElement('img');
        img.src = 'images/balt-t.GIF';
    ...
    // Create initial set of GIFs
    for (let i = 0; i < 9; i++) {
        createAndAnimateGIF();
    }

    // Continuously create new GIFs at random intervals
    setInterval(createAndAnimateGIF, 1000); // Adjust interval as needed
});
